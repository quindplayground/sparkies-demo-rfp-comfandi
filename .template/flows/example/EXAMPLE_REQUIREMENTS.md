...
- Type: Table
- Location: portafolios_iceberg.db_quind_code_generation_stage_dev.tbl_dim_mat_portafolios_poststage_ppd_emr
- Format: Iceberg
...
- Environment variables:
  ...
  - GLUE_CATALOG_DB_STAGE: db_quind_code_generation_stage_dev
