...
```bash
# From project root
cd demo-comfandi-project/demo_comfandi_project/flows
...
1. **`job.py`**:
   ...
   - Import paths: `from demo_comfandi_project.flows._template_flow.*` → `from demo_comfandi_project.flows.your_flow_name.*`
...
```python
# Before:
from demo_comfandi_project.flows._template_flow.extract import extract
from demo_comfandi_project.flows._template_flow.load import load
from demo_comfandi_project.flows._template_flow.transform import transform

# After:
from demo_comfandi_project.flows.your_flow_name.extract import extract
from demo_comfandi_project.flows.your_flow_name.load import load
from demo_comfandi_project.flows.your_flow_name.transform import transform
```
...
```python
from demo_comfandi_project.flows.your_flow_name.steps.step_100_clean_data import step_100_clean_data
from demo_comfandi_project.flows.your_flow_name.steps.step_200_cast_types import step_200_cast_types
...
from demo_comfandi_project.libs.iceberg.utils import is_empty
...
from demo_comfandi_project.libs.iceberg.cdc_with_tagging_strategy import SnapshotManager
...
from demo_comfandi_project.libs.iceberg.utils import restart_table
...
```python
from demo_comfandi_project.flows.your_flow_name.steps.step_100_remove_duplicates import step_100_remove_duplicates
from demo_comfandi_project.flows.your_flow_name.steps.step_200_cast_types import step_200_cast_types
...
def test_full_flow_execution(spark: SparkSession, mock_vars_resource: VarsResource):
    ...
    from demo_comfandi_project.flows.your_flow_name.job import your_flow_name_job
...
**Problem:** `ImportError: cannot import name 'extract' from 'demo_comfandi_project.flows.your_flow_name.extract'`
...
- `demo_comfandi_project.libs.iceberg.utils`: Table operations
...
- `demo_comfandi_project.libs.iceberg.cdc_with_tagging_strategy`: CDC operations
  - `ChangelogManager`: Manage changelog extraction
  - `SnapshotManager`: Manage snapshot tagging

### Core Utilities

- `demo_comfandi_project.libs.error_handler`: Error handling decorator
- `demo_comfandi_project.libs.logging`: Structured logging
- `demo_comfandi_project.libs.resources`: Configuration management
- `demo_comfandi_project.libs.common_patterns`: Common transformation patterns
