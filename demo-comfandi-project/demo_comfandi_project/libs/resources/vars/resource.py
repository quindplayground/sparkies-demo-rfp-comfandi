...
def get_vars_resource(
    ...
    Raises:
        ModuleNotFoundError: If demo_comfandi_project package is not found.
    """
    try:
        root = get_package_resource_path("demo_comfandi_project")
    except Exception:
        raise ModuleNotFoundError("demo_comfandi_project package not found")
