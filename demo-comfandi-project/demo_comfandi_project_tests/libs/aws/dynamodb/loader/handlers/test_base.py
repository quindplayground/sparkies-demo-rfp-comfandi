...
from demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base import (
...
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.get_table")
...
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.get_table")
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.get_logger")
...
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.get_table")
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.is_retryable_error")
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.time.sleep")
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.handlers.base.get_logger")
