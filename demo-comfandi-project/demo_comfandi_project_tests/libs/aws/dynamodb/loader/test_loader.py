...
from demo_comfandi_project.libs.aws.dynamodb.loader.loader import DynamoDBLoader
...
@patch("demo_comfandi_project.libs.aws.dynamodb.loader.loader.get_logger")
