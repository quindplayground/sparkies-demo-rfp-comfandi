...
from demo_comfandi_project.libs.resources.vars.resource import (
    VarsResource,
    _VarsStore,
    get_vars_resource,
)
...
def test_vars_store_get_base_path(temp_config_dir):
    ...
    with patch(
        "demo_comfandi_project.libs.resources.vars.resource.get_working_path"
    ) as mock_get_path:
...
def test_vars_store_get_conf_instance_error():
    ...
    with patch(
        ...
        "demo_comfandi_project.libs.resources.vars.resource._VarsStore._get_conf_paths"
    ) as mock_get_paths, patch(
        "demo_comfandi_project.libs.resources.vars.resource.Dynaconf", autospec=True
...
def test_get_vars_resource_basic():
    ...
    with patch(
        "demo_comfandi_project.libs.resources.vars.resource.get_package_resource_path",
        return_value="/fake/root",
    ), patch(
        "demo_comfandi_project.libs.resources.vars.resource.Path.exists",
        return_value=True,
    ), patch(
        "demo_comfandi_project.libs.resources.vars.resource.Path.glob",
        return_value=["dummy.yaml"],
    ), patch(
        "demo_comfandi_project.libs.resources.vars.resource.VarsResource"
...
def test_get_vars_resource_package_not_found(monkeypatch):
    ...
    with pytest.raises(ModuleNotFoundError, match="demo_comfandi_project package not found"):
